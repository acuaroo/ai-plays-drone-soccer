...
class DroneController:
    ...
    def move(self, x=0, y=0, z=0, rotation=0):
        ...
        self.drone.send_rc_control(int(
            z * self.speed), int(x * self.speed), int(y * self.speed), int(rotation * self.speed * 2))
    ...
    def move_state(self, new_state):
        ...
        movements = [int(old_state[0]), int(old_state[1]),
                     int(old_state[2]), int(old_state[3])]
